...
private:
	...
	CONSOLE(const TCHAR* name) :stream(nullptr), information{ 0 }{create(name); };
...
public:
	...
	static CONSOLE& getConsole(const TCHAR* name = nullptr) { static CONSOLE console(name); return console; }
	...
	FILE* getFile()const { return stream; }
